...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1388: (x0,x1) => x0.debug(x1),
      _1396: x0 => x0.createReader(),
      ...
      _1421: x0 => ({audio: x0}),
      _1422: (x0,x1) => x0.getUserMedia(x1),
      _1423: x0 => x0.getAudioTracks(),
      _1424: x0 => x0.stop(),
      _1425: x0 => ({video: x0}),
      _1426: x0 => x0.getVideoTracks(),
      _1427: () => globalThis.Notification.requestPermission(),
      ...
      _1430: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1433: (x0,x1) => x0.item(x1),
      ...
      _1439: (x0,x1) => x0.removeChild(x1),
      _1443: (x0,x1) => x0.info(x1),
      _1444: (x0,x1) => x0.initialize(x1),
      _1448: x0 => x0.disableAutoSelect(),
      _1449: Date.now,
      _1451: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1452: s => {
      ...
      _1454: () => typeof dartUseDateNowForTicks !== "undefined",
      _1455: () => 1000 * performance.now(),
      _1456: () => Date.now(),
      _1457: () => {
      ...
      _1459: () => new WeakMap(),
      _1460: (map, o) => map.get(o),
      _1461: (map, o, v) => map.set(o, v),
      ...
      _1487: Object.is,
      _1488: o => o instanceof Array,
      _1489: (a, i) => a.push(i),
      _1490: (a, i) => a.splice(i, 1)[0],
      _1492: (a, l) => a.length = l,
      _1493: a => a.pop(),
      _1494: (a, i) => a.splice(i, 1),
      _1495: (a, s) => a.join(s),
      _1496: (a, s, e) => a.slice(s, e),
      _1497: (a, s, e) => a.splice(s, e),
      _1498: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1499: a => a.length,
      _1501: (a, i) => a[i],
      _1502: (a, i, v) => a[i] = v,
      _1504: o => {
      ...
      _1505: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1507: o => o instanceof Uint8Array,
      _1508: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1509: o => o instanceof Int8Array,
      _1510: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1511: o => o instanceof Uint8ClampedArray,
      _1512: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1513: o => o instanceof Uint16Array,
      _1514: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1515: o => o instanceof Int16Array,
      _1516: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1517: o => o instanceof Uint32Array,
      _1518: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1519: o => o instanceof Int32Array,
      _1520: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1522: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1523: o => o instanceof Float32Array,
      _1524: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1525: o => o instanceof Float64Array,
      _1526: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1527: (t, s) => t.set(s),
      _1528: l => new DataView(new ArrayBuffer(l)),
      _1529: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1531: o => o.buffer,
      _1532: o => o.byteOffset,
      _1533: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1534: (b, o) => new DataView(b, o),
      _1535: (b, o, l) => new DataView(b, o, l),
      _1536: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1537: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1538: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1539: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1540: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1541: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1542: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1543: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1544: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1545: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1546: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1547: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1550: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1551: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1552: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1553: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1554: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1555: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1557: () => globalThis.performance,
      _1558: () => globalThis.JSON,
      _1559: x0 => x0.measure,
      _1560: x0 => x0.mark,
      _1561: x0 => x0.clearMeasures,
      _1562: x0 => x0.clearMarks,
      _1563: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1564: (x0,x1,x2) => x0.mark(x1,x2),
      _1565: x0 => x0.clearMeasures(),
      _1566: x0 => x0.clearMarks(),
      _1567: (x0,x1) => x0.parse(x1),
      _1568: (ms, c) =>
      ...
      _1605: x0 => x0.trustedTypes,
      _1606: (x0,x1) => { x0.src = x1 },
      _1607: (x0,x1) => x0.createScriptURL(x1),
      _1608: x0 => x0.nonce,
      ...
      _1923: (d, precision) => d.toPrecision(precision),
