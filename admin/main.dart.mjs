...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1875: x0 => ({at: x0}),
      _1876: x0 => x0.getSize(),
      _1877: (x0,x1) => x0.truncate(x1),
      _1878: x0 => x0.flush(),
      _1881: x0 => x0.synchronizationBuffer,
      _1882: x0 => x0.communicationBuffer,
      _1883: (x0,x1,x2,x3) => ({clientVersion: x0,root: x1,synchronizationBuffer: x2,communicationBuffer: x3}),
      _1884: x0 => new SharedArrayBuffer(x0),
      _1885: (x0,x1) => globalThis.IDBKeyRange.bound(x0,x1),
      _1886: x0 => ({autoIncrement: x0}),
      _1887: (x0,x1,x2) => x0.createObjectStore(x1,x2),
      _1888: x0 => ({unique: x0}),
      _1889: (x0,x1,x2,x3) => x0.createIndex(x1,x2,x3),
      _1890: (x0,x1) => x0.createObjectStore(x1),
      _1891: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1891(f,arguments.length,x0) }),
      _1892: (x0,x1,x2) => x0.transaction(x1,x2),
      _1893: (x0,x1) => x0.objectStore(x1),
      _1895: (x0,x1) => x0.index(x1),
      _1896: x0 => x0.openKeyCursor(),
      _1897: (x0,x1) => x0.getKey(x1),
      _1898: (x0,x1) => ({name: x0,length: x1}),
      _1899: (x0,x1) => x0.put(x1),
      _1900: (x0,x1) => x0.get(x1),
      _1901: (x0,x1) => x0.openCursor(x1),
      _1902: x0 => globalThis.IDBKeyRange.only(x0),
      _1903: (x0,x1,x2) => x0.put(x1,x2),
      _1904: (x0,x1) => x0.update(x1),
      _1905: (x0,x1) => x0.delete(x1),
      _1906: x0 => x0.name,
      _1907: x0 => x0.length,
      ...
      _1983: x0 => x0.height,
      _1984: x0 => x0.promise,
      _1985: o => o instanceof Array,
      _1986: (a, i) => a.splice(i, 1)[0],
      _1988: (a, l) => a.length = l,
      _1989: a => a.pop(),
      _1990: (a, i) => a.splice(i, 1),
      _1991: (a, s) => a.join(s),
      _1992: (a, s, e) => a.slice(s, e),
      _1993: (a, s, e) => a.splice(s, e),
      _1994: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1995: a => a.length,
      _1997: (a, i) => a[i],
      _1998: (a, i, v) => a[i] = v,
      _2000: o => {
      ...
      _2001: (o, offsetInBytes, lengthInBytes) => {
      ...
      _2004: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _2005: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _2006: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _2007: o => o instanceof Uint8ClampedArray,
      _2008: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _2009: o => o instanceof Uint16Array,
      _2010: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _2011: o => o instanceof Int16Array,
      _2012: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _2013: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _2014: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _2015: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _2016: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _2017: (o, start, length) => new BigUint64Array(o.buffer, o.byteOffset + start, length),
      _2018: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _2019: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _2020: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _2021: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _2022: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _2023: (a, i) => a.push(i),
      _2024: (t, s) => t.set(s),
      _2025: l => new DataView(new ArrayBuffer(l)),
      _2026: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _2027: o => o.byteLength,
      _2028: o => o.buffer,
      _2029: o => o.byteOffset,
      _2030: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _2031: (b, o) => new DataView(b, o),
      _2032: (b, o, l) => new DataView(b, o, l),
      _2033: Function.prototype.call.bind(DataView.prototype.getUint8),
      _2034: Function.prototype.call.bind(DataView.prototype.setUint8),
      _2035: Function.prototype.call.bind(DataView.prototype.getInt8),
      _2036: Function.prototype.call.bind(DataView.prototype.setInt8),
      _2037: Function.prototype.call.bind(DataView.prototype.getUint16),
      _2038: Function.prototype.call.bind(DataView.prototype.setUint16),
      _2039: Function.prototype.call.bind(DataView.prototype.getInt16),
      _2040: Function.prototype.call.bind(DataView.prototype.setInt16),
      _2041: Function.prototype.call.bind(DataView.prototype.getUint32),
      _2042: Function.prototype.call.bind(DataView.prototype.setUint32),
      _2043: Function.prototype.call.bind(DataView.prototype.getInt32),
      _2044: Function.prototype.call.bind(DataView.prototype.setInt32),
      _2045: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      _2046: Function.prototype.call.bind(DataView.prototype.setBigUint64),
      _2047: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _2048: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _2049: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _2050: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _2051: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _2052: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _2053: Function.prototype.call.bind(Number.prototype.toString),
      _2054: Function.prototype.call.bind(BigInt.prototype.toString),
      _2055: Function.prototype.call.bind(Number.prototype.toString),
      _2056: (d, digits) => d.toFixed(digits),
      _2067: x0 => globalThis.fetch(x0),
      _2068: x0 => x0.arrayBuffer(),
      _2074: () => globalThis.google.accounts.oauth2,
      _2075: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      ...
      _2090: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _2091: x0 => x0.requestAccessToken(),
      _2094: x0 => x0.access_token,
      _2095: x0 => x0.expires_in,
      _2101: x0 => x0.error,
      _2102: x0 => x0.error_description,
      _2104: x0 => x0.type,
      _2105: x0 => x0.message,
      _2109: () => globalThis.google.accounts.id,
      _2123: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._2123(f,arguments.length,x0) }),
      ...
      _2137: x0 => x0.error,
      _2139: x0 => x0.credential,
      _2150: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _2151: (module,f) => finalizeWrapper(f, function() { return module.exports._2151(f,arguments.length) }),
      _2261: (x0,x1) => { x0.draggable = x1 },
      _2277: x0 => x0.style,
      _2476: (x0,x1) => { x0.nonce = x1 },
      _2634: (x0,x1) => { x0.target = x1 },
      _2636: (x0,x1) => { x0.download = x1 },
      _2661: (x0,x1) => { x0.href = x1 },
      _3206: (x0,x1) => { x0.accept = x1 },
      _3220: x0 => x0.files,
      _3246: (x0,x1) => { x0.multiple = x1 },
      _3264: (x0,x1) => { x0.type = x1 },
      _3514: (x0,x1) => { x0.src = x1 },
      _3516: (x0,x1) => { x0.type = x1 },
      _3520: (x0,x1) => { x0.async = x1 },
      _3522: (x0,x1) => { x0.defer = x1 },
      _3558: x0 => x0.width,
      _3559: (x0,x1) => { x0.width = x1 },
      _3560: x0 => x0.height,
      _3561: (x0,x1) => { x0.height = x1 },
      _3964: x0 => x0.items,
      _3967: (x0,x1) => x0[x1],
      _3971: x0 => x0.length,
      _3977: x0 => x0.dataTransfer,
      _3981: () => globalThis.window,
      _4020: x0 => x0.document,
      _4023: x0 => x0.location,
      _4042: x0 => x0.navigator,
      _4113: (x0,x1) => { x0.ondragenter = x1 },
      _4115: (x0,x1) => { x0.ondragleave = x1 },
      _4117: (x0,x1) => { x0.ondragover = x1 },
      _4121: (x0,x1) => { x0.ondrop = x1 },
      _4304: x0 => x0.trustedTypes,
      ...
      _4510: x0 => x0.port1,
      _4511: x0 => x0.port2,
      _4513: (x0,x1) => { x0.onmessage = x1 },
      _4567: (x0,x1) => { x0.onmessage = x1 },
      _4578: (x0,x1) => { x0.onmessage = x1 },
      _4590: x0 => x0.port,
      _6570: x0 => x0.signal,
      _6579: x0 => x0.length,
      _6619: x0 => x0.baseURI,
      ...
      _6716: x0 => x0.body,
      _6718: x0 => x0.head,
      _7047: (x0,x1) => { x0.id = x1 },
      _7071: (x0,x1) => { x0.innerHTML = x1 },
      _7074: x0 => x0.children,
      _7380: x0 => x0.clientX,
      _7381: x0 => x0.clientY,
      _8393: x0 => x0.value,
      _8395: x0 => x0.done,
      ...
      _8555: x0 => x0.type,
      _8561: x0 => x0.name,
      _8562: x0 => x0.lastModified,
      _8567: x0 => x0.length,
      _8573: x0 => x0.result,
      _9069: x0 => x0.url,
      _9071: x0 => x0.status,
      _9073: x0 => x0.statusText,
      _9074: x0 => x0.headers,
      _9075: x0 => x0.body,
      _9087: x0 => x0.instance,
      _9089: () => globalThis.WebAssembly,
      _9111: x0 => x0.exports,
      _9119: x0 => x0.buffer,
      _10528: x0 => x0.result,
      _10529: x0 => x0.error,
      _10540: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10542: x0 => x0.oldVersion,
      _10621: x0 => x0.key,
      _10622: x0 => x0.primaryKey,
      _10624: x0 => x0.value,
      _11462: (x0,x1) => { x0.display = x1 },
      _12684: x0 => x0.name,
      _12685: x0 => x0.message,
      _12773: x0 => x0.href,
      _12788: x0 => x0.pathname,
      _13358: x0 => x0.isDirectory,
      _13359: x0 => x0.name,
      _13360: x0 => x0.fullPath,
      _13390: () => globalThis.console,
