...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1290: () => new Sentry.getIsolationScope(),
      _1291: x0 => x0.getSession(),
      _1292: (x0,x1) => x0.setSession(x1),
      ...
      _1297: x0 => globalThis.Sentry.startSession(x0),
      _1298: () => globalThis.Sentry.captureSession(),
      _1299: () => globalThis.globalThis,
      _1300: x0 => ({type: x0}),
      _1301: (x0,x1) => new Blob(x0,x1),
      _1302: x0 => globalThis.URL.createObjectURL(x0),
      _1303: (x0,x1) => x0.getElementById(x1),
      ...
      _1309: x0 => x0.click(),
      _1310: () => ({}),
      _1311: x0 => globalThis.pdfjsLib.getDocument(x0),
      _1312: (x0,x1) => x0.getContext(x1),
      _1313: (x0,x1) => x0.getPage(x1),
      _1314: (x0,x1) => x0.getViewport(x1),
      _1315: (x0,x1) => x0.render(x1),
      _1316: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1316(f,arguments.length,x0) }),
      _1317: (x0,x1) => x0.toBlob(x1),
      _1318: () => new FileReader(),
      _1319: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1320: x0 => x0.cleanup(),
      _1321: x0 => x0.destroy(),
      _1322: (x0,x1) => { x0.module = x1 },
      _1323: (x0,x1) => { x0.exports = x1 },
      _1324: x0 => x0.preventDefault(),
      _1325: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1326: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1328: (x0,x1) => x0.getAttribute(x1),
      _1332: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1344: (x0,x1,x2,x3,x4,x5) => ({clientId: x0,scope: x1,redirectURI: x2,state: x3,nonce: x4,usePopup: x5}),
      _1345: x0 => globalThis.AppleID.auth.init(x0),
      _1346: () => globalThis.AppleID.auth.signIn(),
      _1354: x0 => x0.authorization,
      _1355: x0 => x0.user,
      _1356: x0 => x0.error,
      _1358: x0 => x0.code,
      _1359: x0 => x0.id_token,
      _1360: x0 => x0.state,
      _1361: x0 => x0.email,
      _1362: x0 => x0.name,
      _1363: x0 => x0.firstName,
      _1364: x0 => x0.lastName,
      ...
      _1418: x0 => ({audio: x0}),
      _1419: (x0,x1) => x0.getUserMedia(x1),
      _1420: x0 => x0.getAudioTracks(),
      _1421: x0 => x0.stop(),
      _1422: x0 => ({video: x0}),
      _1423: x0 => x0.getVideoTracks(),
      _1424: () => globalThis.Notification.requestPermission(),
      ...
      _1427: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      ...
      _1436: (x0,x1) => x0.removeChild(x1),
      _1441: (x0,x1) => x0.initialize(x1),
      _1445: x0 => x0.disableAutoSelect(),
      _1446: Date.now,
      ...
      _1459: x0 => new WeakRef(x0),
      _1460: x0 => x0.deref(),
      _1467: () => globalThis.WeakRef,
      _1471: s => JSON.stringify(s),
      _1472: s => printToConsole(s),
      ...
      _1486: (a, i) => a.push(i),
      _1487: (a, i) => a.splice(i, 1)[0],
      _1489: (a, l) => a.length = l,
      _1490: a => a.pop(),
      _1491: (a, i) => a.splice(i, 1),
      _1492: (a, s) => a.join(s),
      _1493: (a, s, e) => a.slice(s, e),
      _1494: (a, s, e) => a.splice(s, e),
      _1495: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1496: a => a.length,
      _1498: (a, i) => a[i],
      _1499: (a, i, v) => a[i] = v,
      _1501: o => {
      ...
      _1524: (t, s) => t.set(s),
      _1525: l => new DataView(new ArrayBuffer(l)),
      ...
      _1585: x0 => x0.read(),
      _1586: x0 => x0.cancel(),
      _1587: () => new XMLHttpRequest(),
      _1588: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1589: x0 => x0.send(),
      ...
      _1608: (x0,x1) => x0.key(x1),
      _1610: (x0,x1) => { x0.data = x1 },
      _1611: (x0,x1) => { x0.scale = x1 },
      _1612: (x0,x1) => { x0.canvasContext = x1 },
      _1613: (x0,x1) => { x0.viewport = x1 },
      _1614: (x0,x1) => { x0.cMapUrl = x1 },
      _1615: (x0,x1) => { x0.cMapPacked = x1 },
      _1616: x0 => x0.promise,
      _1617: x0 => x0.numPages,
      _1618: x0 => x0.width,
      _1619: x0 => x0.height,
      _1620: x0 => x0.promise,
      _1849: (s, m) => {
      ...
      _1879: o => String(o),
      _1880: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1881: o => {
      ...
      _1882: o => [o],
      _1883: (o0, o1) => [o0, o1],
      _1884: (o0, o1, o2) => [o0, o1, o2],
      _1885: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1909: (o, p, v) => o[p] = v,
      _1911: x0 => x0.random(),
      _1912: (x0,x1) => x0.getRandomValues(x1),
      _1913: () => globalThis.crypto,
      _1914: () => globalThis.Math,
      _1915: Function.prototype.call.bind(Number.prototype.toString),
      _1916: Function.prototype.call.bind(BigInt.prototype.toString),
      _1917: Function.prototype.call.bind(Number.prototype.toString),
      _1918: (d, digits) => d.toFixed(digits),
      _1922: () => globalThis.document,
      _1928: (x0,x1) => { x0.height = x1 },
      _1930: (x0,x1) => { x0.width = x1 },
      _1939: x0 => x0.style,
      _1942: x0 => x0.src,
      _1943: (x0,x1) => { x0.src = x1 },
      _1944: x0 => x0.naturalWidth,
      _1945: x0 => x0.naturalHeight,
      _1961: x0 => x0.status,
      _1962: (x0,x1) => { x0.responseType = x1 },
      _1964: x0 => x0.response,
      _1965: () => globalThis.google.accounts.oauth2,
      _1966: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      _1967: (x0,x1) => x0.revoke(x1),
      _1968: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1968(f,arguments.length,x0) }),
      _1969: (x0,x1,x2) => x0.revoke(x1,x2),
      _1985: x0 => x0.access_token,
      _1986: x0 => x0.expires_in,
      _1992: x0 => x0.error,
      _1993: x0 => x0.error_description,
      _1995: x0 => x0.type,
      _1996: x0 => x0.message,
      _2000: () => globalThis.google.accounts.id,
      _2003: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2003(f,arguments.length,x0) }),
      _2004: (x0,x1) => x0.prompt(x1),
      ...
      _2021: x0 => x0.isSkippedMoment(),
      _2022: x0 => x0.isDismissedMoment(),
      _2026: x0 => x0.getDismissedReason(),
      _2028: x0 => x0.error,
      _2030: x0 => x0.credential,
      _2041: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _2042: f => finalizeWrapper(f, function() { return dartInstance.exports._2042(f,arguments.length) }),
      _2091: (x0,x1) => { x0.responseType = x1 },
      _2092: x0 => x0.response,
      _2152: (x0,x1) => { x0.draggable = x1 },
      _2168: x0 => x0.style,
      _2181: (x0,x1) => { x0.oncancel = x1 },
      _2187: (x0,x1) => { x0.onchange = x1 },
      _2227: (x0,x1) => { x0.onerror = x1 },
      _2367: (x0,x1) => { x0.nonce = x1 },
      _2525: (x0,x1) => { x0.target = x1 },
      _2527: (x0,x1) => { x0.download = x1 },
      _2552: (x0,x1) => { x0.href = x1 },
      _3097: (x0,x1) => { x0.accept = x1 },
      _3111: x0 => x0.files,
      _3137: (x0,x1) => { x0.multiple = x1 },
      _3155: (x0,x1) => { x0.type = x1 },
      _3405: (x0,x1) => { x0.src = x1 },
      _3407: (x0,x1) => { x0.type = x1 },
      _3411: (x0,x1) => { x0.async = x1 },
      _3413: (x0,x1) => { x0.defer = x1 },
      _3415: (x0,x1) => { x0.crossOrigin = x1 },
      _3419: (x0,x1) => { x0.integrity = x1 },
      _3449: x0 => x0.width,
      _3450: (x0,x1) => { x0.width = x1 },
      _3451: x0 => x0.height,
      _3452: (x0,x1) => { x0.height = x1 },
      _3855: x0 => x0.items,
      _3858: (x0,x1) => x0[x1],
      _3862: x0 => x0.length,
      _3868: x0 => x0.dataTransfer,
      ...
      _4004: (x0,x1) => { x0.ondragenter = x1 },
      _4006: (x0,x1) => { x0.ondragleave = x1 },
      _4008: (x0,x1) => { x0.ondragover = x1 },
      _4012: (x0,x1) => { x0.ondrop = x1 },
      _4195: x0 => x0.trustedTypes,
      _4197: x0 => x0.localStorage,
      _4207: x0 => x0.origin,
      _4216: x0 => x0.pathname,
      _4301: x0 => x0.geolocation,
      _4304: x0 => x0.mediaDevices,
      _4306: x0 => x0.permissions,
      _4317: x0 => x0.platform,
      ...
      _6482: x0 => x0.length,
      _6522: x0 => x0.baseURI,
      _6528: x0 => x0.firstChild,
      _6539: () => globalThis.document,
      _6619: x0 => x0.body,
      _6621: x0 => x0.head,
      _6950: (x0,x1) => { x0.id = x1 },
      _6974: (x0,x1) => { x0.innerHTML = x1 },
      _6977: x0 => x0.children,
      _7283: x0 => x0.clientX,
      _7284: x0 => x0.clientY,
      _8296: x0 => x0.value,
      _8298: x0 => x0.done,
      ...
      _8479: x0 => x0.type,
      _8485: x0 => x0.name,
      _8486: x0 => x0.lastModified,
      _8491: x0 => x0.length,
      _8496: x0 => x0.result,
      _8993: x0 => x0.url,
      _8995: x0 => x0.status,
      _8997: x0 => x0.statusText,
      _8998: x0 => x0.headers,
      _8999: x0 => x0.body,
      _9266: x0 => x0.type,
      _9281: x0 => x0.matches,
      _9292: x0 => x0.availWidth,
      _9293: x0 => x0.availHeight,
      _9298: x0 => x0.orientation,
      _9785: x0 => x0.active,
      _11398: (x0,x1) => { x0.display = x1 },
      _12620: x0 => x0.name,
      _13303: x0 => x0.isDirectory,
      _13304: x0 => x0.name,
      _13305: x0 => x0.fullPath,
      _13335: () => globalThis.console,
      _13360: () => globalThis.window.flutterCanvasKit,
      _13361: () => globalThis.window._flutter_skwasmInstance,
